...
namespace Drupal\group_welcome_message\Plugin\Mail;
 ...
 *
 * @Mail(
 *   id = "group_welcome_message_swiftmailer",
 *   label = @Translation("Group Welcome Message Swift Mailer"),
 *   description = @Translation("Forces the given body text to be HTML.")
 * )
 */
class GroupWelcomeMessageSwiftMailer extends SwiftMailer {
